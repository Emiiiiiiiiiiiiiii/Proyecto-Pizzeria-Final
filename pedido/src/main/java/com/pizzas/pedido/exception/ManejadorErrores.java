...
public class ManejadorErrores {
    ...
    // Logger para registrar errores del microservicio pedido
    ...
    public ResponseEntity<ErrorDTO> manejarErrorIntegridad(
        ...
        Map<String, String> errores = new LinkedHashMap<>();
        errores.put("baseDatos", "No se pudo guardar la información por una restricción de base de datos.");
    ...
    public ResponseEntity<ErrorDTO> manejarErroresGenerales(
        ...
        ErrorDTO errorDTO = new ErrorDTO(
                ...
                "Ocurrió un error interno en el microservicio de pedido.",
                new LinkedHashMap<>(),
                request.getRequestURI()
        );
