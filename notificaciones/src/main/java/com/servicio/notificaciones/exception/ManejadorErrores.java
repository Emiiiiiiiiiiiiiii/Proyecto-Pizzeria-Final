...
// Maneja errores de forma centralizada para notificaciones
...
public class ManejadorErrores {
    ...
    public ResponseEntity<ErrorDTO> manejarValidaciones(
        ...
        ErrorDTO errorDTO = new ErrorDTO(
                ...
                "Error de validación en notificaciones",
                errores,
    ...
    public ResponseEntity<ErrorDTO> manejarIntegridadDatos(
        ...
        ErrorDTO errorDTO = new ErrorDTO(
                ...
                List.of("No se pudo guardar la notificación porque existen datos inválidos."),
                request.getRequestURI()
        );
    ...
    public ResponseEntity<ErrorDTO> manejarErrorGeneral(
        ...
        ErrorDTO errorDTO = new ErrorDTO(
                ...
                List.of("Ocurrió un error inesperado en notificaciones."),
                request.getRequestURI()
        );
