...
// Maneja errores de forma centralizada para inventario
...
public class ManejadorErrores {
    ...
    public ResponseEntity<ErrorDTO> manejarIntegridadDatos(
        ...
        ErrorDTO errorDTO = new ErrorDTO(
                ...
                List.of("No se pudo guardar inventario porque existen datos repetidos o inválidos."),
                request.getRequestURI()
        );
    ...
    public ResponseEntity<ErrorDTO> manejarErrorGeneral(
        ...
        ErrorDTO errorDTO = new ErrorDTO(
                ...
                List.of("Ocurrió un error inesperado en inventario."),
                request.getRequestURI()
        );
